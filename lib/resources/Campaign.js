...
Campaign.prototype.createCampaign = function(ad_account_id, callback)
{
...
Campaign.prototype.getAllCampaigns = function(ad_account_id, callback)
{
  if(typeof ad_account_id === 'function')
...
Campaign.prototype.updateCampaign = function(options, callback)
{
...
Campaign.prototype.deleteCampaign = function(campaign_id, callback)
{
...
Campaign.prototype.getCampaignById = function(campaign_id, callback)
{
  if (typeof campaign_id === 'function')
    throw new Error('Must pass in an a Campaign Id');
