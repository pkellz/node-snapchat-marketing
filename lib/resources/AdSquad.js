...
AdSquad.prototype.createAdSquad = function(campaign_id, callback)
{
...
AdSquad.prototype.updateAdSquad = function(campaign_id, callback)
{
  if(typeof campaign_id === 'function')
    throw new Error('Must pass in an Campaign Id');
...
AdSquad.prototype.getAllAdSquadsCampaign = function(campaign_id, callback)
{
  if(typeof campaign_id === 'function')
    throw new Error('Must pass in an Campaign Id');
...
AdSquad.prototype.getAllAdSquadsAdAccount = function(ad_account_id, callback)
{
...
AdSquad.prototype.getAdSquadById = function(ad_squad_id, callback)
{
