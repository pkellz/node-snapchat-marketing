...
describe('@Campaign', function(){
  ...
  //   snap.campaign.delete(TEST_CAMPAIGN_ID, function(err, campaigns){
  ...
  it('should get all Campaigns from an Ad Account Id', done => {
    snap.campaign.getAll(TEST_ACCOUNT_ID, function(err, campaigns){
  ...
  //   snap.campaign.getById(TEST_CAMPAIGN_ID, function(err, campaign){
  //     console.log(campaign);
  //     expect(err).toBeNull();
  //     expect(campaign).not.toBeNull();
  //     done();
